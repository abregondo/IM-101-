...
function likePost(button) {
  ...
  function postComment() {
    ...
    if (commentInput.value.trim()) {
      ...
      // Optionally close the comment input field after posting
      // commentSection.style.display = 'none';  // Uncomment this line to close the comment section after posting
    }
  }
